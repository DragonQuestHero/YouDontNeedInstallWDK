...
//
// General input data structure.
// Any data structures in input buffer after SRB_IO_CONTROL should contain FIRMWARE_REQUEST_BLOCK.
//
...
typedef struct _STORAGE_FIRMWARE_DOWNLOAD { 
    ...
    ULONGLONG   Offset;             // image file offset, should be DWORD aligned.
    ULONGLONG   BufferSize;         // should be multiple of sizeof(DWORD)
