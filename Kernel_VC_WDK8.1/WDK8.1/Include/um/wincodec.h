...
EXTERN_C const IID IID_IWICBitmapDecoderInfo;
    ...
    public:
        virtual /* [local] */ HRESULT STDMETHODCALLTYPE GetPatterns( 
            ...
            _Inout_opt_  UINT *pcPatterns,
            /* [annotation][out] */ 
            _Inout_opt_  UINT *pcbPatternsActual) = 0;
    ...
    typedef struct IWICBitmapDecoderInfoVtbl
    {
        ...
        /* [local] */ HRESULT ( STDMETHODCALLTYPE *GetPatterns )( 
            ...
            _Inout_opt_  UINT *pcPatterns,
            /* [annotation][out] */ 
            _Inout_opt_  UINT *pcbPatternsActual);
...
HRESULT WINAPI WICCreateBitmapFromSection(
     ...
     _In_ UINT stride,
     _In_ UINT offset,
     _Outptr_result_buffer_(1) IWICBitmap **ppIBitmap
     );
...
HRESULT WINAPI WICMapGuidToShortName(
    _In_reads_(1) REFGUID guid,
    _In_ UINT cchName,
    _Inout_updates_opt_(cchName) WCHAR *wzName,
    _Out_writes_(1) UINT *pcchActual
   );
...
HRESULT WINAPI WICMapSchemaToName(
    _In_reads_(1) REFGUID guidMetadataFormat,
    _In_reads_(1) LPWSTR pwzSchema,
    _In_ UINT cchName,
    _Inout_updates_opt_(cchName) WCHAR *wzName,
    _Out_writes_(1) UINT *pcchActual
    );
