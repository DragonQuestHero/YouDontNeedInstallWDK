...
INT APIENTRY EngMultiByteToWideChar(
    _In_                                    UINT CodePage,
    _Out_writes_bytes_opt_(BytesInWideCharString) LPWSTR WideCharString,
    _In_                                    INT BytesInWideCharString,
    _In_reads_bytes_opt_(BytesInMultiByteString) LPSTR MultiByteString,
...
INT APIENTRY EngWideCharToMultiByte(
    _In_                                    UINT CodePage,
    _In_reads_bytes_opt_(BytesInWideCharString) LPWSTR WideCharString,
    _In_                                    INT BytesInWideCharString,
    _Out_writes_bytes_opt_(BytesInMultiByteString) LPSTR MultiByteString,
    _In_                                    INT BytesInMultiByteString
    );
...
__forceinline
ULONG
#pragma warning(suppress: 6001 6101) // PREFast incorrectly assesses the TRUE return case.
