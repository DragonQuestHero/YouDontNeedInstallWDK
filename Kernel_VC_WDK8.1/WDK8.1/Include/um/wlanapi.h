...
// String identifying Miracast protocol support in Wi Fi Direct services property
static const WCHAR c_szMiracast[] = L"Miracast";

// The constant for Wi Fi Direct services. Since there is just one right now, it is simpler to define a constant as multi string value.
...
// Availability: If Miracast capable, set to string indicating Miracast service (c_Miracast) or empty
//
DEFINE_DEVPROPKEY(
