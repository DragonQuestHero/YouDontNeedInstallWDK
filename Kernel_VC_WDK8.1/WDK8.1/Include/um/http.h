...
HttpSetRequestQueueProperty(
    ...
    _In_reads_bytes_(PropertyInformationLength) IN PVOID pPropertyInformation,
    IN ULONG PropertyInformationLength,
    _Reserved_ IN ULONG Reserved,
    _Reserved_ IN PVOID pReserved
    );
...
HttpQueryRequestQueueProperty(
    IN HANDLE Handle,
    IN HTTP_SERVER_PROPERTY Property,
    _Out_writes_bytes_to_opt_(PropertyInformationLength, *pReturnLength)
...
HttpReceiveClientCertificate(
    ...
    IN ULONG Flags,
    _Out_writes_bytes_to_(SslClientCertInfoSize, *pBytesReceived)
    OUT PHTTP_SSL_CLIENT_CERT_INFO pSslClientCertInfo,
    IN ULONG SslClientCertInfoSize,
    _Out_opt_ OUT PULONG pBytesReceived OPTIONAL,
...
HttpReceiveHttpRequest(
    ...
    IN ULONG Flags,
    _Out_writes_bytes_to_(RequestBufferLength, *pBytesReturned)
    OUT PHTTP_REQUEST pRequestBuffer,
    IN ULONG RequestBufferLength,
    _Out_opt_ OUT PULONG pBytesReturned OPTIONAL,
    IN LPOVERLAPPED pOverlapped OPTIONAL
    );
...
HttpReceiveRequestEntityBody(
    ...
    IN HTTP_REQUEST_ID RequestId,
    IN ULONG Flags,
    _Out_writes_bytes_to_(EntityBufferLength, *pBytesReturned) PVOID pBuffer,
...
HttpSendHttpResponse(
    ...
    _Reserved_ PVOID pReserved1, // must be NULL
    _Reserved_ ULONG Reserved2, // must be 0
    IN LPOVERLAPPED pOverlapped OPTIONAL,
...
HttpReadFragmentFromCache(
    ...
    _Out_writes_bytes_to_(BufferLength, *pBytesRead) PVOID pBuffer,
    IN ULONG BufferLength,
    _Out_opt_ PULONG pBytesRead,
    IN LPOVERLAPPED pOverlapped OPTIONAL
    );
