...
#define JET_paramMaxValueInvalid				189 //	This is not a valid parameter. It can change from release to release!


//	session paramters
//
#define JET_sesparamBase					4096						//	
#define JET_sesparamCommitDefault			( JET_sesparamBase + 1 )	//	default grbit for JetCommitTransaction
...
JetDefragmentA(
	...
	_Out_opt_ unsigned long *	pcPasses,
	_Out_opt_ unsigned long *	pcSeconds,
	_In_ JET_GRBIT				grbit );
...
JET_ERR JET_API
JetGetAttachInfoW(
	_Out_writes_bytes_to_opt_( cbMax, *pcbActual ) JET_PWSTR	wzzDatabases,
	_In_ unsigned long										cbMax,
	_Out_opt_ unsigned long *								pcbActual );
