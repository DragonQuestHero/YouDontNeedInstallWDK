...
// Path:    ...\TimeProviders\<PrividerName>\RunOnVirtual
// Type:    REG_DWORD (cast to BOOL)
// Meaning: If true, this provider should be allowed to run only on virtual
//          machine, if false vice-versa.
#define wszW32TimeRegValueRunOnVirtualOnly    L"RunOnVirtualOnly"
