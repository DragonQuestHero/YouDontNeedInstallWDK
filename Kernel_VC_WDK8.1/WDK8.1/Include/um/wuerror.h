...
//
#define WU_E_CALL_CANCELLED_BY_HIDE      _HRESULT_TYPEDEF_(0x80240056L)
...
//
#define WU_E_CALL_CANCELLED_BY_INVALID   _HRESULT_TYPEDEF_(0x80240057L)
...
////
//
// MessageId: WU_E_HARDWARECAPABILITY_PARTIAL_RESULT
//
// MessageText:
//
// Operation failed for a subset of of the capability checks.
//
#define WU_E_HARDWARECAPABILITY_PARTIAL_RESULT _HRESULT_TYPEDEF_(0x8024B100L)
