...
//
// This flag controls LsaLookupSids2 such that Internet accounts cached locally
// will be mapped to their local names, not Internet names.
//
#define LSA_LOOKUP_PREFER_LOCAL_NAMES  0x80000000
