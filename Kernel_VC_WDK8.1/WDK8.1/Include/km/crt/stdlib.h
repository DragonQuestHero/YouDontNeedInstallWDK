 ...
 */
#ifndef MB_CUR_MAX
#if defined (_MT) && (defined (_M_CEE_PURE))
...
_Check_return_opt_ _CRTIMP errno_t __cdecl _dupenv_s(_Outptr_result_buffer_maybenull_(*_PBufferSizeInBytes) _Deref_post_z_ char **_PBuffer, _Out_opt_ size_t * _PBufferSizeInBytes, _In_z_ const char * _VarName);
