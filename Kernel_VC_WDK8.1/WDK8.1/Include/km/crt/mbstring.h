...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsnbcpy_s) unsigned char * __cdecl _mbsnbcpy(_Out_writes_(_Count) _Post_maybez_ unsigned char *, _In_z_ const unsigned char *, _In_ size_t _Count);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsncpy_s) unsigned char * __cdecl _mbsncpy(_Pre_notnull_ _Out_writes_(2*_Count) _Post_maybez_ unsigned char *, _In_z_ const unsigned char *, _In_ size_t _Count);
