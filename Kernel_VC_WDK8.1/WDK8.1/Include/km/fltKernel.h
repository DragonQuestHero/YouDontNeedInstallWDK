...
#define FLT_PUSH_LOCK_ENABLE_AUTO_BOOST               (0x1)
#define FLT_PUSH_LOCK_VALID_FLAGS                     (0x1)
...
#define FltAcquirePushLockExclusive(Lock) \
        FltAcquirePushLockExclusiveEx(Lock, FLT_PUSH_LOCK_ENABLE_AUTO_BOOST)

#define FltAcquirePushLockShared(Lock) \
        FltAcquirePushLockSharedEx(Lock, FLT_PUSH_LOCK_ENABLE_AUTO_BOOST)

#define FltReleasePushLock(Lock) \
        FltReleasePushLockEx(Lock, FLT_PUSH_LOCK_ENABLE_AUTO_BOOST)
