...
DEFINE_GUID( GUID_CS_BATTERY_SAVER_THRESHOLD, 0x1e133d45, 0xa325, 0x48DA, 0x87, 0x69, 0x14, 0xAE, 0x6D, 0xC1, 0x17, 0x0B );
DEFINE_GUID( GUID_CS_BATTERY_SAVER_ACTION, 0xC10CE532, 0x2EB1, 0x4B3C, 0xB3, 0xFE, 0x37, 0x46, 0x23, 0xCD, 0xCF, 0x07 );
DEFINE_GUID( GUID_CS_BATTERY_SAVER_TIMEOUT, 0x7398e821, 0x3937, 0x4469, 0xB0, 0x7B, 0x33, 0xEB, 0x78, 0x5A, 0xAC, 0xA1);
...
#define ADDRESS_AND_SIZE_TO_SPAN_PAGES(Va,Size) \
    ((ULONG) ((BYTE_OFFSET (Va) + ((SIZE_T) (Size)) + (PAGE_SIZE - 1)) >> PAGE_SHIFT))
