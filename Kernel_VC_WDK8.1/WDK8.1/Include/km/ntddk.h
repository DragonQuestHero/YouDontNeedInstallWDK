...
C_ASSERT(FIELD_OFFSET(KUSER_SHARED_DATA, Reserved2) == 0x260);
...
C_ASSERT(FIELD_OFFSET(KUSER_SHARED_DATA, QpcSystemTimeIncrementShift) == 0x370);
C_ASSERT(FIELD_OFFSET(KUSER_SHARED_DATA, QpcInterruptTimeIncrementShift) == 0x371);
C_ASSERT(FIELD_OFFSET(KUSER_SHARED_DATA, UnparkedProcessorCount) == 0x372);
C_ASSERT(FIELD_OFFSET(KUSER_SHARED_DATA, Reserved8) == 0x374);
...
HalExamineMBR(
    ...
    _Out_writes_bytes_(_Inexpressible_("Depends on MBRTypeIdentifier")) PVOID *Buffer
    );
#endif
