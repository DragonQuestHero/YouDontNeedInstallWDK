...
typedef enum _WDF_PROPERTY_STORE_ROOT_CLASS
{
    ...
    WdfPropertyStoreRootDriverParametersKey     = 0x04,
    WdfPropertyStoreRootMaximum
...
typedef struct _WDF_PROPERTY_STORE_ROOT
{
    ...
    union
    {
        ...
        {
            //
            // This is the name of the driver service. The Parameters key is
            // HKLM\SW\MS\WinNT\CurrentVersion\WUDF\Services\<ServiceName>\Parameters.
            //
            PCWSTR ServiceName;
        } ParametersKey;
    } Qualifier;
